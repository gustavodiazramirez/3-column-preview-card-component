...
const Sedans = () => {
  return (
    <div className="bg-primary-bright-orange w-[370px] flex flex-col justify-center px-16 pt-10 hidden:rounded-l-xl xl:rounded-l-xl">
      ...
      <h1 className="text-white uppercase font-semibold font-big-shoulders-display text-4xl pt-10 pb-6">
        Sedans
      </h1>
      ...
      <button className="flex items-start pt-24 pb-16">
        <span className="bg-white text-primary-bright-orange p-3 px-10 rounded-full font-semibold hover:border-2 hover:bg-primary-bright-orange hover:text-white hover:transition-all">Learn more</span>
      </button>
    </div>
  );
};
