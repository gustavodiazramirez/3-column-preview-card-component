  ...
  return (
    <div className="bg-primary-dark-cyan text-primary-dark-cyan w-[370px] h-auto flex flex-col items-left justify-center px-16 pt-10">
      ...
      <button className="flex items-start pt-24 pb-16">
        <span className="bg-white  p-3 px-10 rounded-full font-semibold hover:border-2 hover:bg-primary-dark-cyan text-primary-dark-cyan hover:text-white hover:transition-all">
          Learn more
        </span>
      </button>
    </div>
